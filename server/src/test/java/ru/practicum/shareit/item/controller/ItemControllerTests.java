...
import ru.practicum.shareit.item.comment.mapping.CommentMapperImpl;
import ru.practicum.shareit.item.dto.ItemDtoRequest;
import ru.practicum.shareit.item.dto.ItemDtoResponse;
import ru.practicum.shareit.item.dto.LongItemDtoResponse;
import ru.practicum.shareit.item.entity.Item;
import ru.practicum.shareit.item.service.ItemService;
import ru.practicum.shareit.item.mapping.ItemMapperImpl;
...
public class ItemControllerTests {
    ...
    @Test
    void shouldGetItemsOfUserWithCustomParams() throws Exception {
    ...
    void shouldGetItemsContainingText() throws Exception {
        ...
        mockMvc.perform(get("/items/search?text=Кастрюля&from=0&size=10")
                        .characterEncoding(StandardCharsets.UTF_8)
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
