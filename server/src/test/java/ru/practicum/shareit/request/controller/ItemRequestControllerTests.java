...
public class ItemRequestControllerTests {
    ...
    void shouldCreateRequest() throws Exception {
        ...
        mockMvc.perform(post("/requests")
                ...
                .andExpect(jsonPath("$.created", is(dtoResponse.getCreated().format(ofPattern("yyyy-MM-dd'T'HH:mm:ss.SSS")))))
    ...
    void shouldGetRequests() throws Exception {
        ...
        mockMvc.perform(get("/requests")
                ...
                .andExpect(jsonPath("$[0].created", is(dtoResponse.getCreated().format(ofPattern("yyyy-MM-dd'T'HH:mm:ss.SSS")))))
    ...
    @Test
    void shouldGetRequestsWithParams() throws Exception {
